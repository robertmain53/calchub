...
defineNuxtConfig({
  ...
  robots: {
    disallow: _nodeProcess.default.env.NODE_ENV === 'development' ? '/' : ''
  },
  ...
  runtimeConfig: {
    public: {
      siteUrl: _nodeProcess.default.env.SITE_URL || 'https://socalsolver.com',
      apiBase: _nodeProcess.default.env.API_BASE_URL
    }
  },
