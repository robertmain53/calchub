import { c as createRule, k as isNotCommaToken } from '../utils.js';
import { AST_NODE_TYPES, AST_TOKEN_TYPES } from '@typescript-eslint/utils';
import { isTokenOnSameLine, isClosingBracketToken, isClosingBraceToken } from '@typescript-eslint/utils/ast-utils';
...
var objectCurlySpacing = createRule({
  ...
  create(context) {
    ...
    function getClosingBraceOfObject(node) {
      const lastProperty = node.type === "TSTypeLiteral" ? node.members[node.members.length - 1] : node.properties[node.properties.length - 1];
